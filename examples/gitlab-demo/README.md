...
| 4 | **Compliance artifact** | `reports: dotenv:` → MR variables (`AIIR_AI_PERCENT`, `AIIR_SIGNED_RECEIPT_COUNT`, `AIIR_UNSIGNED_RECEIPT_COUNT`, etc.) |
...
MR opened
  ...
  │
  ├─► Compliance tab
  │     └─ AIIR_RECEIPT_COUNT=3, AIIR_AI_PERCENT=67, AIIR_SIGNED_RECEIPT_COUNT=3, AIIR_UNSIGNED_RECEIPT_COUNT=0, ...
  │
  └─► Duo Chat
...
See [`gitlab-compliance-framework.md`](../../docs/integrations/gitlab-compliance-framework.md).
...
- [Duo recipe](../../docs/integrations/gitlab-duo-recipe.md)
- [Compliance Framework guide](../../docs/integrations/gitlab-compliance-framework.md)
