...
JSON core fields. Change one character and the hash breaks, so verification
fails.
...
[Sigstore keyless signing](../integrations/ci-platforms.md#sigstore-signing). A signed receipt
...
The AIIR specification includes [25 conformance test vectors](../../schemas/test_vectors.json)
