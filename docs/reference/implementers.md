...
>
> This registry is the adoption proof for the [standards-readiness scorecard](../spec/standards-readiness.md).
...
|---|---|---|---|---|
| Invariant Systems | AIIR receipts every commit in the aiir repo itself (dogfooding) | 2025-11 | No | Uses all four interfaces: CLI, GitHub Action, GitLab CI, MCP. See [case study](../case-studies/aiir-self-dogfood.md). |
...
Pilots count even if aiir is not yet in production.
