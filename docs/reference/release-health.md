...
No active release incidents are currently tracked. Routine CI and documentation maintenance does not affect the published v1.7.0 release.
...
|---|---|---|
| v1.7.0 | 2026-06-13 | Agent-receipt profile (aiir agent emit/verify), portable release evidence bundles, two security hardening passes, and a documentation information-architecture refresh |
