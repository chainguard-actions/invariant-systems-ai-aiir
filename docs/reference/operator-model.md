...
It covers tamper evidence, optional signing, and policy evaluation. Hidden-use
detection, code quality judgment, and governance decisions still require a human
owner.
