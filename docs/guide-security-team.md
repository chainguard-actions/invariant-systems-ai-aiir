...
gh attestation verify aiir-1.4.0-py3-none-any.whl \
...
curl -s https://pypi.org/integrity/aiir/1.4.0/aiir-1.4.0-py3-none-any.whl/provenance \
  | python3 -m json.tool
```
...
```bash
aiir --artifact dist/aiir-1.4.0-py3-none-any.whl \
