...
receipts for **every MR across your entire organization** with no per-project
setup needed.
...
5. ✅ **Export dotenv variables**: `AIIR_RECEIPT_COUNT`, `AIIR_AI_COMMIT_COUNT`, `AIIR_AI_PERCENT`, `AIIR_SIGNED_RECEIPT_COUNT`, `AIIR_UNSIGNED_RECEIPT_COUNT`
