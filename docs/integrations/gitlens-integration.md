...
GitLens now exposes AI-assisted commit workflows (including MCP tooling). AIIR treats that as an upstream activity source and generates a verifiable receipt immediately afterward.
