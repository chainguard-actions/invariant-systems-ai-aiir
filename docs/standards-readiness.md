...
## Weekly Operating Score: 2026-W17
...
| 🔴 Adoption | 2.0 | ❌ red | Internal case study published; no external pilots on record |
...
Last updated: 2026-04-26 · Cycle: 2026-W17
...
| Adoption maturity | 10 | 2.0 | 4.0 | External pilots and integrations in the wild |
| **Composite** | **100** | | **72.8** | |
...
**Current: 2.0** — AIIR uses AIIR (dogfooding, *last verified: 2026-04-26*); PyPI+GitHub Marketplace live; EU AI Act compliance positioning; `docs/implementers.md` registry published (invites external entries); public internal case study published at `docs/case-studies/aiir-self-dogfood.md`. Missing: external adopters and third-party pilots on record.
...
|---|---|---|
| Test count | `pytest --collect-only -q \| tail -1` | 2026-03-31 (2214 tests collected) |
...
| Release version | `aiir --version` / PyPI | 2026-03-31 (v1.3.0) |
| Governance score | This doc, Governance Neutrality section | 2026-03-11 (2.2/5) |
| Adoption score | `docs/implementers.md` | 2026-04-26 (2.0/5) |
