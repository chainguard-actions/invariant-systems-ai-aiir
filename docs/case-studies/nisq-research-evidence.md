...
This case study matters because it shows the intended separation of concerns:
...
That is the correct level of quantum-specific metadata for AIIR: receipt
context, not quantum engine logic.
