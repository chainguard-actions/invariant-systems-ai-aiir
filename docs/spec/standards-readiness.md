...
- [x] ~~Document JS + Rust as second implementations~~ → `docs/reference/implementers.md` (2026-03-11)
...
- [x] ~~Publish SDK guidance in `docs/reference/sdks.md`~~ → `docs/reference/sdks.md` (2026-05-02)
...
- [x] Prepare a public talk/blog abstract for external review (2026-04-28)
...
| Release version | `aiir --version` / PyPI | 2026-06-13 (v1.7.0) |
| Governance score | This doc, Governance Neutrality section | 2026-06-04 (2.6/5, draft artifacts rendered; not submitted) |
| Adoption score | `docs/reference/implementers.md` | 2026-06-04 (2.1/5) |
...
Completed foundation work (Mar-Apr 2026)
  ...
  ✅ docs/reference/release-health.md published (P0 policy, RCA template, smoke test badge)
  ✅ .github/workflows/release-smoke.yml (automated post-release smoke, P0 alert)
  ✅ docs/reference/implementers.md published (third-party implementations + pilots registry)
...
June/July 2026: Adoption proof
  ...
  ✦ Record any public pilots in docs/reference/implementers.md
...
- This document lives at `docs/spec/standards-readiness.md` and is linked from `invariantsystems.io`.

---

*AIIR is a vendor-led open specification on a transparent standards track. This scorecard is published weekly.*
