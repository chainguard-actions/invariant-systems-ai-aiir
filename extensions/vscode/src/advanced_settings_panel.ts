...
<body>
    ...
    <div class="hero">
        ...
        <div class="actions">
            <button onclick="cmd('workbench.action.openSettings', 'aiir')">Open AIIR Settings</button>
    ...
    <section>
        ...
        <div class="setting-grid">
            <div class="setting-card">
                ...
                <div class="actions"><button onclick="cmd('workbench.action.openSettings', 'aiir.allowedWorkspaceFolders')">Edit Setting</button></div>
            </div>
            <div class="setting-card">
                ...
                <div class="actions"><button onclick="cmd('workbench.action.openSettings', 'aiir.enforceWorkspaceIsolation')">Edit Setting</button></div>
            </div>
            <div class="setting-card">
                ...
                <div class="actions"><button onclick="cmd('workbench.action.openSettings', 'aiir.strictLocalOnly')">Edit Setting</button></div>
            </div>
        </div>
    </section>
    ...
    <section>
        ...
        <div class="setting-grid">
            <div class="setting-card"><div class="label">CLI path</div><div class="value"><code>${escapeHtml(view.cliPath)}</code></div><div class="actions"><button onclick="cmd('workbench.action.openSettings', 'aiir.cliPath')">Edit Setting</button></div></div>
            <div class="setting-card"><div class="label">Auto-receipt args</div><div class="value"><code>${escapeHtml(JSON.stringify(view.autoReceiptArgs))}</code></div><div class="actions"><button onclick="cmd('workbench.action.openSettings', 'aiir.autoReceiptArgs')">Edit Setting</button></div></div>
            <div class="setting-card"><div class="label">Agent model hint</div><div class="value"><code>${escapeHtml(view.agentModelHint || '—')}</code></div><div class="actions"><button onclick="cmd('workbench.action.openSettings', 'aiir.agentModelHint')">Edit Setting</button></div></div>
            <div class="setting-card"><div class="label">Hub base URL</div><div class="value"><code>${escapeHtml(view.hubBaseUrl || '—')}</code></div><div class="actions"><button onclick="cmd('workbench.action.openSettings', 'aiir.hubBaseUrl')">Edit Setting</button></div></div>
            <div class="setting-card"><div class="label">Hub tenant ID</div><div class="value"><code>${escapeHtml(view.hubTenantId || '—')}</code></div><div class="actions"><button onclick="cmd('workbench.action.openSettings', 'aiir.hubTenantId')">Edit Setting</button></div></div>
            <div class="setting-card"><div class="label">Hub signup endpoint</div><div class="value"><code>${escapeHtml(view.hubSignupEndpoint || '—')}</code></div><div class="actions"><button onclick="cmd('workbench.action.openSettings', 'aiir.hubSignupEndpoint')">Edit Setting</button></div></div>
            <div class="setting-card"><div class="label">Hub feature flag</div><div class="value">${view.enableHubFeatures ? 'Requested in workspace settings' : 'Disabled in workspace settings'}</div><div class="actions"><button onclick="cmd('workbench.action.openSettings', 'aiir.enableHubFeatures')">Edit Setting</button></div></div>
        </div>
