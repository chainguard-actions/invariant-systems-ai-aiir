...
async function withFakeCliHarness(callback) {
    ...
    await vscode.workspace.getConfiguration('aiir').update('cliPath', harness.wrapperPath, vscode.ConfigurationTarget.Workspace);
...
describe('AIIR extension-host smoke', () => {
    ...
    afterEach(async () => {
        ...
        await vscode.workspace.getConfiguration('aiir').update('cliPath', undefined, vscode.ConfigurationTarget.Workspace);
    ...
    it('resumes a pending generate action after CLI availability is restored', async () => {
        ...
        try {
            ...
            await vscode.workspace.getConfiguration('aiir').update('cliPath', path.join(harness.root, 'missing-aiir'), vscode.ConfigurationTarget.Workspace);
