...
function buildPublishSequence() {
    return [
        ...
        'Keep the VS Code Marketplace token in the canonical local vault and sync it into the GitHub Actions environment `automation-secrets` as `VSCE_PAT`; do not treat repo secrets or shell history as the canonical home.',
