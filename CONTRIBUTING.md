...
python -m pytest tests/ -q  # 2,499 collected tests, ~4 min
```
...
- **Test everything.** We maintain 2,499 collected tests across unit, integration, security, and fuzz suites. 100% coverage enforced.
...
See [docs/testing.md](docs/testing.md) for focused-test loops,
