...
python -m pytest tests/ -q  # 2214 collected tests, ~4 min
```
...
The current `main` policy requires the three composite CI gates above. The
...
- **Test everything.** We maintain 2,214 collected tests across unit, integration, security, and fuzz suites. 100% coverage enforced.
