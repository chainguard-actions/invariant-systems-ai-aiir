...
[docs/implementers.md](docs/implementers.md).
...
| GitLab Pages dashboard | [`docs/gitlab-pages-dashboard.md`](docs/gitlab-pages-dashboard.md) |
...
| Implementation and conformance registry | [`docs/implementers.md`](docs/implementers.md) |
