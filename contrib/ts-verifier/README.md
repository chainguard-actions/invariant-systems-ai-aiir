...
This is **not** a port of the Python reference implementation. It was written from the specification alone, to show that SPEC.md is sufficient for interoperable third-party implementations.

## Conformance

This implementation passes all 25 published [core test vectors](../../schemas/test_vectors.json) from spec version 1.0.0.
