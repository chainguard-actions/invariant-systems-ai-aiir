...
patches every file that embeds the package version string. The VS Code
extension carries an independent sidecar version and is intentionally
excluded from this sync pass. Designed to be called
from:
