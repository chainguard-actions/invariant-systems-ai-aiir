...
AIIR_RULES: list[Rule] = [
    ...
    # docs/release-health.md  →  **Current release**: vX.Y.Z
    Rule(
        "docs/release-health.md",
        r"\*\*Current release\*\*:\s*v(?P<ver>\d+\.\d+\.\d+)",
        "**Current release**: v{version}",
    ),
    # docs/release-health.md  →  published vX.Y.Z release.
    Rule(
        "docs/release-health.md",
        r"published v(?P<ver>\d+\.\d+\.\d+) release\.",
        "published v{version} release.",
    ),
    # docs/verify-independently.md  →  aiir-X.Y.Z-py3-none-any.whl
    Rule(
        "docs/verify-independently.md",
    ...
    # docs/guide-solo-developer.md  →  rev: vX.Y.Z
    Rule(
        "docs/guide-solo-developer.md",
        r"rev:\s*v(?P<ver>\d+\.\d+\.\d+)",
        "rev: v{version}",
    ),
    # docs/guide-security-team.md  →  python scripts/verify-release-evidence.py X.Y.Z
    Rule(
        "docs/guide-security-team.md",
        r"python scripts/verify-release-evidence\.py (?P<ver>\d+\.\d+\.\d+)",
        "python scripts/verify-release-evidence.py {version}",
    ),
    # docs/guide-security-team.md  →  aiir-X.Y.Z-py3-none-any.whl
    Rule(
        "docs/guide-security-team.md",
        r"aiir-(?P<ver>\d+\.\d+\.\d+)-py3-none-any\.whl",
        "aiir-{version}-py3-none-any.whl",
    ),
    # docs/guide-security-team.md  →  /integrity/aiir/X.Y.Z/aiir-X.Y.Z-py3-none-any.whl/provenance
    Rule(
        "docs/guide-security-team.md",
