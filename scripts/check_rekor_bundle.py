...
from aiir._sign import summarize_sigstore_bundle, validate_sigstore_bundle
from aiir._transparency import verify_transparency_material
...
def validate_bundle(artifact_path: Path, bundle_path: Path) -> list[str]:
    ...
    return validate_sigstore_bundle(artifact_path.read_bytes(), bundle)
...
def main(argv: list[str] | None = None) -> int:
    ...
    summary = summarize_sigstore_bundle(_load_json(bundle_path))
